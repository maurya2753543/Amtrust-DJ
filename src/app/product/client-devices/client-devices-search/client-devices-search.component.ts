...
@Component({
  ...
  templateUrl: './client-devices-search.component.html',
  styleUrls: ['./client-devices-search.component.css']
})
export class ClientDevicesSearchComponent implements OnInit {
